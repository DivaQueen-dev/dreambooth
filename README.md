...
- (If applicable: `react-router` for routing)  
- (If applicable: a photo library like `react-webcam`, `gif.js` or similar)  
- Build tool: `create-react-app` (or whatever you used)  
- Deployment: Hosted on GitHub Pages / Vercel / *(choose)*
